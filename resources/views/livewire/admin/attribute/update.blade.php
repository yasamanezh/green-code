@section('title','ویرایش مشخصه')
<div class="container-fluid">
    <div class="inner-body">
        <div class="page-header">
            <div>
                <h2 class="main-content-title tx-24 mg-b-5"> ویرایش مشخصه</h2><br>
                <ol class="breadcrumb">
            ...
            <div>
                <button class="btn btn-primary" wire:click.prevent="saveInfo"  wire:loading.remove>ویرایش</button>
                ...
                <div class="card custom-card">
                    ...
                    <div class="card-body birder">
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <input type="text" name="title" placeholder="عنوان "  class="form-control @error('title') is-invalid @enderror"  wire:model.lazy="title">
                                @error('title')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <input type="text" name="prefix" placeholder="واحد(پسوند) "  class="form-control @error('prefix') is-invalid @enderror"  wire:model.lazy="prefix">
                                @error('prefix')
                        ...
                        <div class="form-group">
                            <div class="row row-sm">
                                ...
                                <div class="col-sm-10">
                                    <input wire:model="sort"  placeholder="ترتیب" class="form-control @error('sort') is-invalid @enderror">
                                    @error('sort')
                                    <div class="invalid-feedback  display-block">
                                        {{ $message }}
                                    </div>
