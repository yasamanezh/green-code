@section('title','وبدئو ها')
<div class="container-fluid" wire:init="loadCategory">
    <div class="inner-body">
        <div class="page-header">
            <div>
                <h2 class="main-content-title tx-24 mg-b-5">ویدئو  ها</h2><br>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{route('Dashboard')}}">داشبورد</a></li>
                    <li class="breadcrumb-item active" aria-current="page">ویدئو  ها</li>
                </ol>
            </div>
            <div>
                <a class="btn btn-primary my-2 btn-icon-text" href="{{route('AddVideo')}}">افزودن
                                                ...
                                                @if($readyToLoad)
                                                    ...
                                                    @foreach($data_info as $info)
                                                        <tr role="row">
                                                            ...
                                                            <td>{{App\Models\Category::where('id',$info->product->category)->pluck('title')->first()}}</td>
                                                            ...
                                                            <td>
                                                                <a href="{{route('EditVideo',$info->id)}}"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h4>برای حذف ویدئو اطمینان دارید؟</h4>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" wire:click.prevent="delete" class="btn btn-danger"><i
                            class="fa fa-trash ml-1"></i>حذف ویدئو
                    </button>
                </div>
            </div>
        </div>
    ...
    <div class="modal fade" id="form" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h4>برای حذف گروهی ویدئو  ها اطمینان دارید؟</h4>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" wire:click.prevent="deleteAll()" class="btn btn-danger"><i
                            class="fa fa-trash ml-1"></i>حذف ویدئو  ها
                    </button>
                </div>
            </div>
        </div>
