@section('title','ویرایش لایسنس')
<div class="container-fluid">
    <div class="inner-body">
        <div class="page-header">
            <div>
                <h2 class="main-content-title tx-24 mg-b-5">ویرایش لایسنس</h2>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{route('Dashboard')}}">داشبورد</a></li>
                    <li class="breadcrumb-item"><a href="{{route('Licences')}}">لایسنسها</a></li>
                    <li class="breadcrumb-item active" aria-current="page">ویرایش لایسنس</li>
                </ol>
            </div>
            <div>
