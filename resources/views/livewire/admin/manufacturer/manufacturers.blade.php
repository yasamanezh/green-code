...
<div class="container-fluid" wire:init="loadBrand">
    <div class="inner-body">
        <div class="page-header">
            <div>
                <h2 class="main-content-title tx-24 mg-b-5">برندها</h2><br>
                <ol class="breadcrumb">
            ...
            <div>
                <a href="{{route('AddBrand')}}" class="btn btn-primary">
                    افزودن
                                        ...
                                        <div class="table-responsive scrollbar" id="style-1">
                                            <table class="table dataTable no-footer dtr-inline collapsed" id="example2"
                                                ...
                                                <tr role="row">
                                                    ...
                                                    <th>تصویر</th>
                                                    <th class="wd-lg-20p"><span
                                                            style="margin-right: 15px;"> عنوان </span>
                                                    ...
                                                    @foreach($data_info as $info)
                                                        <tr role="row">
                                                            <td>
                                                                <label class="ckbox">
                                                                    <input name="selected" value="{{$info->id}}"
                                                                           wire:model="mulitiSelect" type="checkbox">
                                                            ...
                                                            <td>
                                                                ...
                                                                <a href="{{route('Editbrand',$info->id)}}"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h4>برای حذف برند اطمینان دارید؟</h4>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" wire:click.prevent="delete" class="btn btn-danger"><i
                            class="fa fa-trash ml-1"></i>حذف برند
                    </button>
                </div>
            </div>
        </div>
    ...
    <div class="modal fade" id="form" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h4>برای حذف گروهی برند ها اطمینان دارید؟</h4>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" wire:click.prevent="deleteAll()" class="btn btn-danger"><i
                            class="fa fa-trash ml-1"></i>حذف برند ها
                    </button>
                </div>
            </div>
        </div>
