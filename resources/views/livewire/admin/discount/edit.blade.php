...
<div class="container-fluid">
    <div class="inner-body" >
        <div class="page-header">
            <div>
                <h2 class="main-content-title tx-24 mg-b-5">ویرایش تخفیف</h2><br>
                <ol class="breadcrumb">
            ...
            <div>
                <button wire:click.prevent="categoryForm" wire:loading.remove  class="btn btn-primary my-2 btn-icon-text submit"  type="submit" for="form" wire:loading.attr="disabled">ویرایش</button>
                        ...
                        <form id="form" enctype="multipart/form-data" role="form" class="padding-10 categoryForm">
                            ...
                            <div style="display: {{$DiscountType ==1 ? 'block':'none'}}">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="scrollbar" id="style-1" style="height:150px;width:200px;overflow:auto">
                                            @foreach($categories as $category)
                                                <div>
                                                    <label class="ckbox submit">
                                                        <input wire:model="selectGroup.{{$category->id}}" type="checkbox" value="{{ $category->id }}">
                                                        <span>--{{$category->title}}--</span></label>
                                                </div>
                                                @foreach(\App\Models\Product::where('category',$category->id)->get() as $product)
                                                    <div>
                                                        <label class="ckbox submit">
                                                            <input wire:model="selected" type="checkbox"  value="{{$product->id}}">
                            ...
                            <div class="form-group row">
                                <label class="form-label col-sm-2">کد تخفیف : <span class="tx-danger">*</span></label>
                                <input type="text" wire:model.defer="discount.code" placeholder="کد تخفیف " class="form-control col-sm-10">
                            </div>
                            <div class="form-group row">
                                <label class="form-label col-sm-2">تعداد : <span class="tx-danger">*</span></label>
                                <input type="text" wire:model.defer="discount.count" placeholder="مثلا 4" class="form-control col-sm-10">
                            </div>
                              <div class="form-group row">
                                <label class="form-label col-sm-2"> مقدار تخفیف (تومان) : <span class="tx-danger">*</span></label>
                                <input type="text" wire:model.defer="discount.price" placeholder="مثلا 4000" class="form-control col-sm-10">
                            </div>
                            </div>
