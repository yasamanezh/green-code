@section('title','افزودن ایمیل')
<div class="container-fluid">
    <div class="inner-body">
        <div class="page-header">
            <div>
                <h2 class="main-content-title tx-24 mg-b-5">افزودن ایمیل</h2><br>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{route('Dashboard')}}">داشبورد</a></li>
                    <li class="breadcrumb-item"><a href="{{route('EmailNotification')}}">ایمیل ها</a></li>
                    <li class="breadcrumb-item active" aria-current="page">افزودن ایمیل</li>
                </ol>
            </div>
            <div>
