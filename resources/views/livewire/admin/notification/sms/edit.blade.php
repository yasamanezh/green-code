@section('title','ویرایش پیامک')
<div class="container-fluid">
    <div class="inner-body">
        <div class="page-header">
            <div>
                <h2 class="main-content-title tx-24 mg-b-5">ویرایش پیامک</h2><br>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{route('Dashboard')}}">داشبورد</a></li>
                    <li class="breadcrumb-item"><a href="{{route('SmsNotification')}}">پیامک ها</a></li>
                    <li class="breadcrumb-item active" aria-current="page">ویرایش پیامک</li>
                </ol>
            </div>
            <div>
                ...
                <a data-toggle="tooltip" href="{{route('SmsNotification')}}" class="btn btn-warning text-white"
                    ...
                    <div class="card-body" >
                        <form id="form" enctype="multipart/form-data" role="form" class="padding-10 categoryForm">
                            <div class="form-group row">
                                <label class="form-label col-sm-2">محتوای پیامک: <span class="tx-danger">*</span></label>
                                <textarea type="text" wire:model.defer="payamak.content" class="form-control col-sm-10"></textarea>
                            </div>
                            <div class="form-group row"  wire:ignore >
                                <label for="showproducts" class="form-label col-sm-2">کاربران:</label>
                                <div class="col-sm-10">
                                    <div style="height:150px;width:200px;overflow:auto">
                                        <label class="ckbox submit" wire:ignore  >
                                            <input  wire:ignore.self name="selected" wire:model="SelectAll" type="checkbox">
                                            <span  class="tx-13">انتخاب همه</span>
                                        </label>
                                        @foreach($users as $user)
                                            <div >
                                                <label class="ckbox" wire:ignore>
                                                    <input wire:ignore  wire:model.defer="showUserIds" type="checkbox"
                                                           value="{{$user->id}}">
                            ...
                            <div class="form-group row" wire:ignore>
                                <label wire:ignore class="form-label col-sm-2">زمان ارسال: <span class="tx-danger">*</span></label>
