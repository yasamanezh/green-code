@section('title','افزودن پیامک')
<div class="container-fluid">
    <div class="inner-body">
        <div class="page-header">
            <div>
                <h2 class="main-content-title tx-24 mg-b-5">افزودن پیامک</h2><br>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{route('Dashboard')}}">داشبورد</a></li>
                    <li class="breadcrumb-item"><a href="{{route('SmsNotification')}}">پیامک ها</a></li>
                    <li class="breadcrumb-item active" aria-current="page">افزودن پیامک</li>
                </ol>
            </div>
            <div>
                <button wire:click.prevent="categoryForm" class="btn btn-primary my-2 btn-icon-text submit"
                        type="submit" for="form" wire:loading.attr="disabled" wire:loading.remove>اضافه کردن
                </button>
