@section('title','ویرایش html')
<div class="container-fluid">
    <div class="inner-body">
        <div class="page-header">
            <div>
                <h2 class="main-content-title tx-24 mg-b-5">ویرایش html</h2>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{route('Dashboard')}}">داشبورد</a></li>
                    <li class="breadcrumb-item"><a href="{{route('Htmls')}}">ماژول های html</a></li>
                    <li class="breadcrumb-item active" aria-current="page">ویرایش html</li>
                </ol>
            </div>
            <div>
                <button wire:click.prevent="saveInfo" id="submit" type="submit" class="btn btn-primary"  wire:loading.remove >ذخیره</button>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10" wire:ignore>
                                        <textarea rows="10" id="summernote-editor"
                                                  ...
                                                  autocomplete="off">{{$html->description}}</textarea>
