@section('title','ایجاد دسته وبلاگ')
<div class="container-fluid">
    <div class="inner-body">
        <div class="page-header">
            <div>
                <h2 class="main-content-title tx-24 mg-b-5">ایجاد دسته وبلاگ</h2>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{route('Dashboard')}}">داشبورد</a></li>
                    <li class="breadcrumb-item"><a href="{{route('Blogs.blog')}}">وبلاگ</a></li>
                    <li class="breadcrumb-item active" aria-current="page">ایجاد دسته وبلاگ</li>
                </ol>
            </div>
            <div>
