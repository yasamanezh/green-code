@section('title','سطل زباله دسته بندی وبلاگ')
<div class="container-fluid">
    <div class="inner-body">
        <div class="page-header">
            <div>
                <h2 class="main-content-title tx-24 mg-b-5">سطل زباله دسته بندی وبلاگ</h2><br>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{route('Dashboard')}}">داشبورد</a></li>
                    <li class="breadcrumb-item"><a href="{{route('Blogs.blog')}}">وبلاگ</a></li>
                    <li class="breadcrumb-item active" aria-current="page">سطل زباله وبلاگ</li>
                </ol>
            </div>
            <div>
        ...
        <div class="row row-sm">
            <div class="col-lg-12">
                <div class="card custom-card">
                    <div class="card-header p-3 tx-medium my-auto tx-white bg-primary">سطل زباله وبلاگ</div>
                    <div class="card-body">
                                            ...
                                            <tr role="row">
                                                ...
                                                <td>
                                                    <div class="btn-icon-list">
                                                        <a wire:click.prevent="trashedCategory({{$info->id}})"
