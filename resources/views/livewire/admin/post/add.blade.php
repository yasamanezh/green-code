...
<div class="container-fluid">
    <div class="inner-body">
        <div class="page-header">
            <div>
                <h2 class="main-content-title tx-24 mg-b-5">افزودن پست</h2>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{route('Dashboard')}}">داشبورد</a></li>
                    <li class="breadcrumb-item"><a href="{{route('post.blog')}}">پست ها</a></li>
                    <li class="breadcrumb-item active" aria-current="page">افزودن پست</li>
                </ol>
            </div>
            <div>
                <button form="form-post" type="submit" id="submit"  class="btn btn-primary"  wire:target="saveInfo"
        ...
        <form id="form-post" wire:submit.prevent="saveInfo()" class="form-horizontal">
            <div class="row">
                <div class="col-sm-12">
