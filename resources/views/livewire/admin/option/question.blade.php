@section('title','پرسش ها')
<div class="container-fluid">
    <div class="inner-body" wire:init="loadCategory">
        <div class="page-header">
            <div>
                <h2 class="main-content-title tx-24 mg-b-5">پرسش ها</h2><br>
                <ol class="breadcrumb">
                                ...
                                <div class="table-responsive scrollbar" id="style-1" >
                                    <table class="table dataTable no-footer dtr-inline ">
                                        ...
                                        <tr role="row" class="title-row">
                                            ...
                                            <th class="wd-lg-20p"><span style="margin-right: 15px;">پرسش</span>
                                                <span wire:click="sortBy('question')" class="float-right text-sm"
                                                      style="cursor: pointer;">
                                                            <i class="fa fa-arrow-up {{ $sortColumnName === 'question' && $sortDirection === 'asc' ? '' : 'text-muted' }}"></i>
                                                            <i class="fa fa-arrow-down {{ $sortColumnName === 'question' && $sortDirection === 'desc' ? '' : 'text-muted' }}"></i>
                                                        </span>
                                            </th>
                                            <th class="wd-lg-5p">
                                        ...
                                        @if($readyToLoad)
                                            ...
                                            @foreach($questions as $value)
                                                <tr role="row">
                                                    ...
                                                    <td> {{\Illuminate\Support\Str::limit($value->question, 30)}}</td>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h4>برای حذف پرسش اطمینان دارید؟</h4>
                </div>
                <div class="modal-footer">
                    ...
                    <button type="button" wire:click.prevent="delete" class="btn btn-danger"><i
                            class="fa fa-trash ml-1"></i>حذف پرسش
                    </button>
                </div>
            </div>
        </div>
    ...
    <div class="modal fade" id="form" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h4>برای حذف گروهی پرسش ها اطمینان دارید؟</h4>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" wire:click.prevent="deleteAll()" class="btn btn-danger"><i
                            class="fa fa-trash ml-1"></i>حذف پرسش ها
                    </button>
                </div>
            </div>
        </div>
