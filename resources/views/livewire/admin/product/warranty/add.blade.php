...
<div class="container-fluid">
    <div class="inner-body">
        <div class="page-header">
            <div>
                <h2 class="main-content-title tx-24 mg-b-5">ایجاد گارانتی</h2>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{route('Dashboard')}}">داشبورد</a></li>
                    <li class="breadcrumb-item"><a href="{{route('warrantys')}}">گارانتی ها</a></li>
                    <li class="breadcrumb-item active" aria-current="page">ایجاد گارانتی</li>
                </ol>
            </div>
            <div wire:ignore>
                <button id="submit" class="btn btn-primary" wire:click.prevent="saveInfo"  wire:loading.remove>ذخیره</button>
                            ...
                            <div class="card-body component-item " id="collapseGeneral" wire:ignore.self>
                                <div class="form-group">
                                    <div class="row row-sm">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" wire:model.defer="name" placeholder="نام گارانتی "
                                                   class="form-control">
                                            @error('name')
