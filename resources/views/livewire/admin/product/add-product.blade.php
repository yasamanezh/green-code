                ...
                <div class="col-xl-3 col-lg-12 col-md-12">
                    <div class="card custom-card">
                        <ul class="item1-links nav nav-tabs  mb-0">
                            ...
                            <li class="nav-item">
                                <a wire:ignore data-target="#links" class="nav-link " data-toggle="tab"
                                   role="tablist"
                                   style="cursor: pointer;"> لینک
                                    ها</a>
                            </li>
                            <li class="nav-item">
                                <a wire:ignore data-target="#attribute" class="nav-link" data-toggle="tab"
                                   role="tablist"
                                   style="cursor: pointer;">مشخصات</a>
                            </li>
                            <li class="nav-item">
                                <a wire:ignore data-target="#NaghdOption" class="nav-link" data-toggle="tab"
                                   role="tablist"
                            ...
                            <li class="nav-item">
                                <a wire:ignore data-target="#tab-image" class="nav-link" data-toggle="tab"
                                   role="tablist"
                                   style="cursor: pointer;">تصاویر</a>
                            </li>
                            <li class="nav-item">
                                <a wire:ignore data-target="#tab-option" class="nav-link" data-toggle="tab"
                                   role="tablist"
                        ...
                        <div class="card-body">
                            <form>
                                <div class="tab-content" id="myTabContent">
                                    <div wire:ignore.self class="tab-pane fade show active" id="general"
                                         role="tabpanel">
                                        <div>
                                                ...
                                                <div class="row row-sm">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input type="number" min="0" max="100"
                                                               wire:model.defer="product.sell"
                                                               name="product.sell"
                                                               placeholder="درصد تخفیف" id="input-price"
                                            ...
                                            <div class="form-group ">
                                                <div class="row row-sm">
                                                    <label class="form-label col-sm-2">لینک: <span
                                                                class="tx-danger">*</span></label>
                                                    <div class="col-sm-10">
                                                        <input type="text" wire:model.defer="product.slug"
                                                               value=""
                                    ...
                                    <div wire:ignore.self class="tab-pane " id="links" role="tabpanel">
                                        ...
                                        <div class="form-group">
                                            <div class="row row-sm">
                                                ...
                                                <div class="col-md-10">
                                                    <x-inputs.select2 wire:model.defer="showproducts"
                                                                      id="showproducts"
                                                        ...
                                                        <td>
                                                            <div class="wd-300">
                                                                <input type="file" class="form-control"
                                                                       wire:model="download_file.{{ $key }}"
                                                                       placeholder="فایل">
                                                            </div>
                                                            <span class="mt-2 text-danger" wire:loading
                                                                  wire:target="download_file.{{ $key }}">در حال آپلود ...</span>
                                                            @isset($download_file[$key])
                                                                <span class="mt-2 text-success">آپلود کامل شد</span>
                                                            @endisset
                                                        </td>
                                                        <td>
                                                            <button class="bbtn ripple btn-secondary text-white btn-icon btn-sm"
                                                ...
                                                <div class="col-sm-10">
                                                    @if($image)
                                                        <img
                                                                ...
                                                                class="form-control"
                                                                id="picture" src="{{$image->temporaryUrl()}}">
                                                    @else
                                                        <img
                                                                style="width: 200px;height:200px;padding: 10px;border:2px dashed #ddd;margin-top: 10px;cursor: pointer;"
                                                                        ...
                                                                        <div class="row row-sm">
                                                                            <div class="col-sm-6">
                                                                                <a class="btn ripple btn-primary"
                                                                                   style="margin-top: 15px;color: #fff">
                                                                                            ...
                                                                                            @isset($optionType1[$key])
                                                                                                @foreach($optionType1[$key] as $key1)
                                                                                                    <tr id="option-value-row{{$key . $key1}}">
                                                                                                        <td class="text-left">
                                                                                                            <div class="wd-150">
                                                                                                                <input wire:model.defer="option_value.{{ $key}}.{{ $key1 }}"
                                                                                                                       class="form-control">
                                                                                                            </div>
                                                                                                        </td>
                                                                                                        @if($type=='color')
                                                                                                            <td>
                                                                                                                <div class="wd-150">
                                                                                                                    <input wire:model.defer="option_color.{{ $key}}.{{ $key1 }}"
                                                                                                                           class="form-control"
                                                                                                                           type="color">
                                                                                                                </div>
                                                                                                            </td>
                                                                                                        ...
                                                                                                        <td class="text-right">
                                                                                                            <div class="wd-150">
                                                                                                                <input wire:model.defer="option_quantity.{{ $key}}.{{ $key1 }}"
                                                                                                                       placeholder="تعداد"
                                                                                                                       class="form-control">
                                                                                                            </div>
                                                                                                        </td>
                                                                                                        <td class="text-left">
                                                                                                            <div class="wd-150">
                                                                                                                <select class="form-control"
                                                                                                                        wire:model.defer="option_anbar.{{ $key}}.{{ $key1 }}">
                                                                                                                    <option value="1"
                                                                                                                            selected="selected">
                                                                                                                        بله
                                                                                                                    </option>
                                                                                                        ...
                                                                                                        <td class="text-right">
                                                                                                            <div class="wd-150">
                                                                                                                <select class="form-control"
                                                                                                                        wire:model.defer="price_prefix.{{ $key}}.{{ $key1 }}">
                                                                                                                    <option value="1"
                                                                                                                            selected="selected">
                                                                                                                        +
                                                                                                                    </option>
                                                                                                            ...
                                                                                                            <div class="wd-150">
                                                                                                                <input type="text"
                                                                                                                       wire:model.defer="option_price.{{ $key}}.{{ $key1 }}"
                                                                                                                       placeholder="قیمت"
                                                                                                                       class="form-control">
                                                                                                            </div>
                                                                                                        </td>
                                                                                                        <td class="text-right">
                                                                                                            <div class="wd-150">
                                                                                                                <select class="form-control"
                                                                                                                        wire:model.defer="weight_prefix.{{$key}}.{{ $key1 }}">
                                                                                                                    <option value="1"
                                                                                                                            selected="selected">
                                                                                                                        +
                                                                                                                    </option>
                                                                                                            ...
                                                                                                            <div class="wd-150">
                                                                                                                <input type="text"
                                                                                                                       wire:model.defer="option_weight.{{$key}}.{{ $key1}}"
                                                                                                                       placeholder="وزن"
                                                                                                                       class="form-control">
                                                                                                            </div>
                                                                                                        </td>
                ...
                $('#summernote-editor').summernote({
                    ...
                    callbacks: {
                        onChange: function (contents, $editable) {
                            @this.
                            set('product.description', contents);
                        }
                    },
                });
            ...
            <script>
                $(function () {
                    $('#showproducts').select2({
                        ...
                        @this.
                        set('showproducts', $('#showproducts').val());
                    })
                })
            </script>
        @endpush
