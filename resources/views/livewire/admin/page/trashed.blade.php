@section('title','سطل زباله برگه ها')
<div class="container-fluid">
    <div class="inner-body">
        <div class="page-header">
            <div>
                <h2 class="main-content-title tx-24 mg-b-5">سطل زباله برگه ها</h2><br>
                <ol class="breadcrumb">
        ...
        <div class="row row-sm">
            <div class="col-lg-12">
                <div class="card custom-card">
                    <div class="card-header p-3 tx-medium my-auto tx-white bg-primary">سطل زباله برگه ها</div>
                    <div class="card-body">
