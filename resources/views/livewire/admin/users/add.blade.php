...
<div class="container-fluid">
    <div class="inner-body">
        <div class="page-header">
            <div>
                <h2 class="main-content-title tx-24 mg-b-5">افزودن کاربر</h2>
                <ol class="breadcrumb">
            ...
            <div>
                <button wire:click.prevent="updateUser" class="btn btn-primary my-2 btn-icon-text" type="submit"
                        wire:loading.attr="disabled" wire:loading.remove>افزودن
                </button>
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                ...
                                @endif
                                <br>
                                <input name="img" type="file" wire:model.lazy="photo" style="display:none"
                                ...
                                @enderror
                                <span class="mt-2 text-danger" wire:loading wire:target="photo">در حال آپلود ...</span>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="name " class="form-label col-sm-2">نام و نام خانوادگی:<span
                        ...
                        <div class="form-group row">
                            <label for="phone" class="form-label col-sm-2">شماره موبایل:<span
                                        class="tx-danger"> * </span></label>
                        ...
                        <div class="form-group row">
                            <label for="role" class="form-label col-sm-2">نقش کاربر:</label>
                            <select class="form-control col-sm-10" wire:model="role">
                                <option value="admin">ادمین سایت</option>
                                <option value="hamkar">همکار سایت</option>
