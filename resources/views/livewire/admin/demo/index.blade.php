...
<div class="container-fluid">
    <div class="inner-body" wire:init="loadDemo">
        <div class="page-header">
            <div>
                <h2 class="main-content-title tx-24 mg-b-5">دموها</h2><br>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{route('Dashboard')}}">داشبورد</a></li>
                    <li class="breadcrumb-item active" aria-current="page">دموها</li>
                </ol>
            </div>
            <div class="d-flex">
                <div class="justify-content-center">
                    <a class="btn btn-primary my-2 btn-icon-text" href="{{route('demoAdd')}}">افزودن دمو
                    </a>
                    <a class="btn btn-primary my-2 btn-icon-text" href="{{route('demoTrashed')}}">سطل زباله
                        ({{\App\Models\Demo::onlyTrashed()->count()}})
                    </a>
                </div>
            </div>
        </div>
                                        ...
                                        <table class="table dataTable no-footer dtr-inline ">
                                            ...
                                            <tr role="row">
                                                <th style="padding-right: 15px;" class="wd-lg-5p">
                                                    <label class="ckbox">
                                                        <input name="selected"  wire:model="SelectDemo"
                                                               type="checkbox"><span
                                                            class="tx-13"></span>
                                                    </label>
                                                </th>
                                            ...
                                            @if($readyToLoad)
                                                ...
                                                @foreach($demos as $info)
                                                    <tr role="row">
                                                        ...
                                                        <td>
                                                            <a target="_blank" href="{{route('AllDemo',$info->link)}}" class="btn btn-sm btn-info">
                                                                <i class="fa fa-eye"></i>
                                                            </a>
                                                        </td>
                                                        <td>
                                                            <a href="{{route('demoupdate',$info->id)}}"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h4>برای حذف دمو اطمینان دارید؟</h4>
                </div>
                <div class="modal-footer">
                    ...
                    <button type="button" wire:click.prevent="delete" class="btn btn-danger"><i
                            class="fa fa-trash ml-1"></i>حذف دمو
                    </button>
                </div>
            </div>
        </div>
    ...
    <div class="modal fade" id="form" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h4>برای حذف گروهی دمو ها اطمینان دارید؟</h4>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary" data-bs-dismiss="modal"><i
                            class="fa fa-times ml-1"></i> انصراف
                    ...
                    <button type="button" wire:click.prevent="deleteAll()" class="btn btn-danger"><i
                            class="fa fa-trash ml-1"></i>حذف دمو ها
                    </button>
                </div>
            </div>
        </div>
