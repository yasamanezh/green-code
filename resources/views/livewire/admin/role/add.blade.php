...
<div class="container-fluid">
    <div class="inner-body">
        <div class="page-header">
            <div>
                <h2 class="main-content-title tx-24 mg-b-5">ایجاد مقام</h2>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{route('Dashboard')}}">داشبورد</a></li>
                    <li class="breadcrumb-item"><a href="{{route('Roles')}}">مقام ها</a></li>
                    <li class="breadcrumb-item active" aria-current="page">ایجاد مقام</li>
                </ol>
            </div>
            <div>
                    ...
                    <div class="card-body">
                        <form>
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <input type="text" name="title" placeholder="نام مقام "
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <input type="text" name="label" placeholder="توضیحات "
