        ...
        <div class="container rtl-dir">
            <div class="row align-items-center">
                ...
                <div class="col-md-6">
                    ...
                    <p class="lead">توسعه کسب کار شما و طراحی انواع سایت های فروشکاهی ، شرکتی ، شخصی و ..</p>
                    <p class="lead">کمک به شرکت ها در درک چالش های فناوری خود و ارائه راه حل های متناسب با نیازها، بودجه
                        و برنامه آنها</p>
        ...
        <div class="container rtl-dir" style="background-size: 100%; background-repeat: no-repeat;">
            <div class="row" style="background-size: 100%; background-repeat: no-repeat;">
                <div class="col-md-4 mb20" style="background-size: 100%; background-repeat: no-repeat;">
                    ...
                    <p>طراحی و توسعه تخصصی وبسایت های نوآورانه ، شرکتی ، خدماتی ، فروشگاهی و ... </p>
                </div>
                <div class="col-md-4 mb20" style="background-size: 100%; background-repeat: no-repeat;">
                    <i class="icon-presentation de-icon mb20"></i>
                    <h4>بهینه سازی و سئو SEO</h4>
                    <p>بهینه سازی و بهبود سئو سایت که باعث افزایش بازدید سایت و بالابردن فروش می شود</p>
                </div>
                <div class="col-md-4 mb20" style="background-size: 100%; background-repeat: no-repeat;">
                    <i class="icon-tools de-icon mb20"></i>
                    <h4>گرافیک</h4>
                    <p>طراحی انواع گرافیک زیبا برای طرح های اختصاصی،امکان طراحی لوگو ، بنر و کارت ویزیت</p>
                </div>
            </div>
        </div>
    </section>
